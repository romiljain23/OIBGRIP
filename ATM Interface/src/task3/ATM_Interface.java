...
public class ATM_Interface {
	...
	public static void main(String[] args) {
		...
		String accname = "Romil Jain"; // Declaring the account details
		String branchname = "Jabalpur West";
		String branchaddress = "Vijay Nagar , Jabalpur";
		String branchIFSC = "JBP12564";
		...
		LocalTime time = LocalTime.now(); // Declaring the time format
								...
								// attempts
		{
							...
							if ((transfamount % 10) == 0) {
								if (transfamount <= balance) {
									if ((balance - transfamount) < 1000) {
										...
										String sf2 = String.format("You have successfully transfered Rs %d to %d",
												transfamount, accno);
										String sf3 = String.format("Your balance is Rs %d", balance);
										System.out.println(sf2);
										System.out.println(sf3);
			...
			if (paper == 1) {
				...
				// String sf8 = String.format("%s %s", LocalDate.now().toString(),
